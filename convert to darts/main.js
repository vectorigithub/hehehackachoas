...
(function (global) {
  ...
  Both explore.html and ligtas.html are treated as 'home' tab —
  call Design.Nav.render('home') on both pages.*/
  var NAV_ITEMS = [
    {
      id:    'home',
      label: 'HOME',
      route: '../../explore.html',   // ── BACKEND: update to your home/explore route
    ...
    },
    {
      id:    'profile',
      label: 'PROFILE',
      route: '../../profile.html',   // ── BACKEND: update to your profile page
  ...
  var Nav = {
     ...
     * @param {string} activeId — 'home' | 'community' | 'profile'
     * Note: use 'home' on both explore.html and ligtas.html
     *
     * Usage on every page:
